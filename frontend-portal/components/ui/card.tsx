...
// Elevation is declared once — a hairline border, no shadow stack on top of it.
// A 1px border under a wide soft shadow is the "ghost card" and reads cheap.
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn('rounded-surface border bg-card text-card-foreground', className)} {...props} />
  ),
)
