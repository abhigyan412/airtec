...
import { Plus, Trash2, Loader2, ShieldOff, CalendarClock, CheckCircle2, Clock, Circle, FileSpreadsheet, Pencil } from 'lucide-react'
...
function AddChaptersForm({ classId, sectionId, subjectName, onSaved }: {
