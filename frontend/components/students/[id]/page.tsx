        ...
        <div className="space-y-5">
          ...
          <Card title="Quick Actions" icon={FileText}>
            <div className="space-y-2">
              <Link href={`/fees?student_id=${id}`}
                className="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm text-gray-600 font-medium hover:bg-indigo-50 hover:text-indigo-700 transition-colors border border-transparent hover:border-gray-100">
                View Fee Invoices <span className="text-gray-300">→</span>
              </Link>
              ...
              <Link href={`/students/${id}/fees`}
                ...
                Fee Summary & Ad-hoc <span className="text-gray-300">→</span>
              </Link>
