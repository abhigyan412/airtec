      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex items-center gap-2">
          <Button asChild variant="outline" size="sm">
            <a href={`${API_BASE}/documents/id-card/${id}`} target="_blank" rel="noreferrer">ID Card</a>
          </Button>
          <Button asChild variant="outline" size="sm">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-5">
          ...
          <Card title="Quick Actions" icon={FileText}>
            <div className="space-y-2">
              <QuickAction href={`/fees?student_id=${id}`} label="View Fee Invoices" />
              <QuickAction href={`/students/${id}/documents`} label="View Documents" />
              <QuickAction href={`/students/${id}/attendance`} label="View Attendance" />
              <QuickAction href={`/students/${id}/fees`} label="Fee Summary & Ad-hoc" />
              <QuickAction href={`http://localhost:4000/api/documents/id-card/${id}`} label="Print ID Card" external />
            </div>
          </Card>
