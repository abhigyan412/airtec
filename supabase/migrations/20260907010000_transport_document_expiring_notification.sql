-- New notification type for Transport Phase 1's compliance-document
-- expiry sweep (vehicle RC/insurance/permit/fitness/pollution, driver
-- license/medical/police-verification). Every trigger site's type must
-- be in this constraint or the insert is silently rejected — see
-- 20260829010000's own copy of this same comment.
