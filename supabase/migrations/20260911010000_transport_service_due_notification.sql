-- New notification type for the vehicle-service-due alert (extends
-- the existing compliance-document sweep to also cover maintenance
-- schedules). Same pattern as every prior addition to this module.
