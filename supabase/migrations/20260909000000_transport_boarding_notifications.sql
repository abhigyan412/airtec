-- New notification types for Transport Phase 3's boarding-event alerts
-- (student_boarded/student_alighted), same pattern as
-- 20260907010000's own copy of this comment: every trigger site's type
-- must be in this constraint or the insert is silently rejected.
