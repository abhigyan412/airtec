-- New notification types for Library Phase 3's due-date sweep and
-- fine/reservation events. Same pattern as every prior addition: a
-- type present in code but missing from this constraint is silently
